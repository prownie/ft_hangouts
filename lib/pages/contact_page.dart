  ...
  void initState() {
    databaseController.instance
      ...
      setState(() {
        ...
        addressController.text = _contact!.address ?? '';
                  ...
                  onTap: () async {
                    ...
                    if (croppedImage != null) {
                      setState(() {
                        ...
                        _contact!.setProfilePicture(imageHelper
                            .base64String(imagePicked.readAsBytesSync()));
                      });
                    }
                  },
                  child: CircleAvatar(
                      ...
                      child: CircleAvatar(
                          ...
                          backgroundImage: imageHelper
                              .imageFromBase64String(_contact!.profilePicture!)
                              .image)),
                ),
